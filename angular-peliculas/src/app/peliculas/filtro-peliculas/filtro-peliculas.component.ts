...
import { FiltroPleiculas } from './filtroPelicula';
...
export class FiltroPeliculasComponent implements OnInit{
  ngOnInit(): void {
    this.leerValoresURL();
    this.buscarPeliculas(this.form.value as FiltroPleiculas);
    this.form.valueChanges.subscribe(valores => {
      this.peliculas = this.peliculasOriginal;
      this.buscarPeliculas(valores as FiltroPleiculas);
      this.escribirParametrosBusquedaEnURL(valores as FiltroPleiculas);
    });
  }

  buscarPeliculas(valores: FiltroPleiculas){
    if(valores.titulo){
  ...
  escribirParametrosBusquedaEnURL(valores: FiltroPleiculas){
    let queryString = [];
    ...
    if(valores.proximosEstrenos){
      queryString.push(`proximoEstrenos=${valores.proximosEstrenos}`);
    }
    if(valores.enCines){
